...
namespace StuddyBot.Dialogs
{
    public class MainDialog : ComponentDialog
    {
        ...
        public MainDialog(IConfiguration configuration, IDecisionMaker decisionMaker, 
            ThreadedLogger _myLogger, UserState userState, DialogInfo dialogInfo)
         ...
         
        {
            ...
            AddDialog(new LoopingDialog(DecisionMaker, _QuestionAndAnswerModel, _myLogger, _DialogInfo));
        ...
        {
            _myLogger.LogMessage(message, "user", time, _DialogInfo.DialogId);
        }
    }
}
